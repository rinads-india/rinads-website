...
const REGISTRY: RinpoToolDefinition[] = [
  ...
  { key: "send_appointment_confirmation", category: "SENSITIVE", description: "Draft a booking confirmation for explicit approval before queueing WhatsApp/SMS", vertical: "salon", requiredPermission: "salon.pos.manage", requiresApproval: true },
  { key: "send_appointment_reminder", category: "SENSITIVE", description: "Draft an appointment reminder for explicit approval before queueing WhatsApp/SMS", vertical: "salon", requiredPermission: "salon.pos.manage", requiresApproval: true },
