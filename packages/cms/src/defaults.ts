...
export const DEFAULT_SEO: SiteSeo[] = [
  ...
  seo(
    "seo_contact",
    "/contact",
    "Contact | Book a Demo or Talk to RINADS",
    "Book a platform demo, talk to sales, or start an implementation conversation.",
  ),
  seo(
    "seo_pricing",
    "/pricing",
  ...
  seo(
    ...
    "/security",
    "Security | RINADS",
    "How RINADS operates AI inside business controls — identity, permissions, approvals, and auditability.",
  ),
  seo(
    "seo_customers",
    "/customers",
    "Customers | RINADS",
    "How organisations use RINADS to run connected business operations.",
  ),
  seo(
    "seo_about",
    "/about",
    "About RINADS | Building the Operating Layer",
    "RINADS is building a connected alternative to fragmented CRM, commerce, project, marketing, and automation tools.",
  ),
  seo(
    "seo_docs",
    "/docs",
    "Documentation | RINADS",
    "Guides and documentation for the RINADS platform.",
  ),
  seo(
    "seo_developers",
    "/developers",
    "Developers | RINADS",
    "Authentication, organisation model, APIs, webhooks, and events — only stable interfaces.",
  ),
  seo(
    "seo_developers_api",
    "/developers/api",
    "API Reference | RINADS Developers",
    "API reference for integrations that are contractually stable.",
  ),
  seo(
    "seo_developers_authentication",
    "/developers/authentication",
    "Authentication | RINADS Developers",
    "How applications authenticate to RINADS developer interfaces.",
  ),
  seo(
    "seo_developers_webhooks",
    "/developers/webhooks",
    "Webhooks | RINADS Developers",
    "Webhook delivery model for supported platform events.",
  ),
  seo(
    "seo_developers_events",
    "/developers/events",
    "Events | RINADS Developers",
    "Event types used across governed workflows and integrations.",
  ),
  seo(
    "seo_integrations",
    "/integrations",
    "Integrations | RINADS",
    "Connect tools to RINADS. Every integration declares live, beta, private preview, or planned status.",
  ),
  seo(
    "seo_changelog",
    "/changelog",
  ...
  seo(
    ...
    "/careers",
    "Careers | RINADS",
    "Join the team building the operating layer for modern businesses.",
  ),
  seo(
    "seo_status",
    "/status",
    "Status | RINADS",
    "Service status for RINADS public surfaces. Claims are only published when backed by monitoring.",
  ),
  seo(
    "seo_legal_dpa",
    "/legal/dpa",
    "Data Processing Addendum | RINADS",
    "Data processing terms for organisations using RINADS — pending counsel-approved publication.",
  ),
  seo(
    "seo_legal_subprocessors",
    "/legal/subprocessors",
    "Subprocessors | RINADS",
    "Subprocessors engaged to deliver RINADS services — pending counsel-approved publication.",
  ),
  seo(
    "seo_company_rinpo_story",
    "/company/rinpo-story",
    "RINPO Story | Company Narrative",
    "Narrative and origin material for RINPO. Product details live at /rinpo.",
  ),
