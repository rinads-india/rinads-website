...
export const VERTICALS: VerticalContent[] = [
  ...
  },
  {
    ...
    summary:
      "Appointments, clients, services, POS, loyalty, campaigns, communications, and reviews — a salon vertical on the shared RINADS core, with RINPO as the assisted interface.",
    capabilities: [
