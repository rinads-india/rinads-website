...
export const OS_PAGES: Record<string, OsPageContent> = {
  ...
  "automation-os": {
    ...
    summary:
      "Workflows, triggers, tool routing, and agent runtime — so routine work becomes reliable system behavior.",
    modules: [
      ...
      { name: "Agent Runtime", description: "RINPO Runtime for agentic execution." },
      { name: "Tool Router", description: "Route actions to the right capability." },
  ...
  "rinads-intelligence": {
    ...
    summary:
      "Business graph, event graph, memory, analytics, decision and recommendation engines, permissions, audit, and agent runtime.",
    modules: [
      { name: "Business Graph" },
      { name: "Event Graph" },
      { name: "AI Gateway" },
